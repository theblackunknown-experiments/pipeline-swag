...
namespace bpipe {
    ...
    template<typename Container>
    typename Container::mapped_type typeCheckedDataRetrieval( Container& container, types::ParameterType expected_type, const ParameterDescription& description )
    {
    ...
    BPIPE_IMPLEMENTATION(ParameterDatabase)::CollectionDescription BPIPE_IMPLEMENTATION(ParameterDatabase)::getParametersDescription( ) const
	{
    	...
    	std::transform(mParameterScalars.begin(), mParameterScalars.end(), description_iterator, BuilderParameterDescriptionFromParameterEntry<types::Scalar, CollectionParameterScalar::mapped_type>());
    	std::advance(description_iterator, mParameterScalars.size());
    	std::transform(mParameterTexts.begin(), mParameterTexts.end(), description_iterator, BuilderParameterDescriptionFromParameterEntry<types::Text, CollectionParameterText::mapped_type>());
    	std::advance(description_iterator, mParameterTexts.size());
    	std::transform(mParameterGPUTextures.begin(), mParameterGPUTextures.end(), description_iterator, BuilderParameterDescriptionFromParameterEntry<types::Texture, CollectionParameterGPUTexture::mapped_type>());
    	std::advance(description_iterator, mParameterGPUTextures.size());
    	std::transform(mParameter8BitsCPUTextures.begin(), mParameter8BitsCPUTextures.end(), description_iterator, BuilderParameterDescriptionFromParameterEntry<types::Texture, CollectionParameter8BitsCPUTexture::mapped_type>());
    	std::advance(description_iterator, mParameter8BitsCPUTextures.size());
    	std::transform(mParameter16BitsCPUTextures.begin(), mParameter16BitsCPUTextures.end(), description_iterator, BuilderParameterDescriptionFromParameterEntry<types::Texture, CollectionParameter16BitsCPUTexture::mapped_type>());
    	std::advance(description_iterator, mParameter16BitsCPUTextures.size());
    	std::transform(mParameter32BitsCPUTextures.begin(), mParameter32BitsCPUTextures.end(), description_iterator, BuilderParameterDescriptionFromParameterEntry<types::Texture, CollectionParameter32BitsCPUTexture::mapped_type>());
    ...
    {
        return typeCheckedDataRetrieval(mParameterScalars, types::Scalar, pdesc);
    }
    ...
    {
        return typeCheckedDataRetrieval(mParameterTexts, types::Text, pdesc);
    }
    ...
    {
        return typeCheckedDataRetrieval(mParameterGPUTextures, types::Texture, pdesc);
    }
    ...
    {
        return typeCheckedDataRetrieval(mParameter8BitsCPUTextures, types::Texture, pdesc);
    }
    ...
    {
        return typeCheckedDataRetrieval(mParameter16BitsCPUTextures, types::Texture, pdesc);
    }
    ...
    {
        return typeCheckedDataRetrieval(mParameter32BitsCPUTextures, types::Texture, pdesc);
    }
